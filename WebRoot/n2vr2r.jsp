...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <base href="<%=basePath%>">
    <title>Recommend researchers by researchers</title>
...
<form  action="n2vr2r.jsp" class="tk-Header-quicksearch" method="POST">
        
        <input type="text" name="q" class="tk-Header-quicksearch-input js-q-autocomplete" placeholder="Researchers " value="" autocomplete="off">
...
<%  String paras;
   ...
   String url = "http://localhost:5000/node2vecRecommend/RtoR?name="+paras;
  ...
  <%
   ...
   %>            
    <div class="tk-Resource js-resource-card" data-resource-type="g" title="<%=array[i][1] %>">
            ...
            <span class="js-card-likes-counter"></span>
        </a>
        <div class="tk-Resource-likes js-card-status" role="button">
