...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <base href="<%=basePath%>">
    <title>Recommend Paper by Researcher</title>
    ...
    <div class="tk-Header">
        <div class="container">
            <header class="row">
                <div class="col-xs-12">
                    <
<form  action="n2vr2p.jsp" class="tk-Header-quicksearch" method="POST">
...
<%  String paras;
   ...
   String url = "http://localhost:5000/node2vecRecommend/RtoP?title="+paras;
