...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <base href="<%=basePath%>">
    <title>Basic information of researher page</title>
...
<form action="basicresearcher.jsp" class="tk-Header-quicksearch" method="POST">
        
        <input type="text" name="q" class="tk-Header-quicksearch-input js-q-autocomplete" placeholder="Reseachers " value="" autocomplete="off">
        <button type="submit" class="tk-Header-quicksearch-button"><span class="fa fa-search"></span></button>
    </form>
<div class="tk-Header-links">
...
<% String paras;
    ...
    paras = request.getParameter("name");
   }
	else{
   ...
   String url = "http://localhost:5000/BasicInfo?node=Researcher&name="+paras;
   ...
   BufferedReader reader = new BufferedReader(new InputStreamReader(Response));
	...
	for (String row : allrow) {
		...
		array[i][0] = allcell[0].split(":")[1];
		array[i][1] = allcell[1].split(":")[1];
		i += 1;
	}
	
	
	
	session.setAttribute("array1",array[0][1]);
        ...
        <div class="tk-Resources row" role="list">
            <div class="col-xs-12">
                  <h2 class="tk-Heading tk-Heading--2 tk-Resources-heading">What you search</h2>
                        <div class="tk-Resource js-resource-card" data-resource-type="h" role="listitem" title="<%out.println(session.getAttribute("array1"));%>" >
	                        <a  class="tk-Resource-labels">       
	         				<span class="tk-Resource-title"><%out.println(session.getAttribute("array1"));%></span>                             
	        				</a>
					        <div class="tk-Resource-likes js-card-status" role="button">
					            
					             <form name="form2" action="basicresearcher.jsp" method="POST">
						         <input type="text" name="name" value=<%out.println(session.getAttribute("rawarray")); %> hidden="hidden">
