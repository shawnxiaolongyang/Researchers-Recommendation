...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <base href="<%=basePath%>">
    <title>Basic information page</title>
...
<form name="form1" action="basicpaper2.jsp" class="tk-Header-quicksearch" method="POST">
        
        <input type="text" name="q" class="tk-Header-quicksearch-input js-q-autocomplete" placeholder="Papers " value="" autocomplete="off">
                  ...
                  <h2 class="tk-Heading tk-Heading--2 tk-Resources-heading">What you search</h2>
                        <div class="tk-Resource js-resource-card" data-resource-type="h" role="listitem" title="<%out.println(session.getAttribute("array1"));%>" >
					        ...
					        <div class="tk-Resource-likes js-card-status" role="button">
					             ...
					             <form name="form2" action="basicpaper2.jsp" method="POST">
