...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=ad1e587c6d95c48af2ca)
 * Config saved to config.json and https://gist.github.com/ad1e587c6d95c48af2ca
 */
...
// modified by Andrei Oghina (AO) on February 17, 2015 to ensure we don't have future dates and use "just now" instead of "a few seconds ago" 
(function (plugin) {
  // AO: define custom fromNowOrNow to display "just now" instead of "a few seconds ago"
  ...
  prep = function($el, timestamp) {
    ...
    // AO: ensure we don't have future dates
    // timestamp = moment(timestamp);
    timestamp = moment.min(moment(timestamp), moment());
    ...
    update: function() {
      ...
      $livestamps.each(function() {
        ...
        if (data === undefined)
          ...
          var from = $this.html(),
              // AO: use custom fromNowOrNow to display "just now" instead of "a few seconds ago"
              // to = data.moment.fromNow();
              to = data.moment.fromNowOrNow();
          if (from != to) {
