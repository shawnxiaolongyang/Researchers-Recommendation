...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <base href="<%=basePath%>">
    <title> Recommend researchers by papers</title>
...
<form  action="n2vp2r.jsp" class="tk-Header-quicksearch" method="POST">
        
        <input type="search" name="q" class="tk-Header-quicksearch-input js-q-autocomplete" placeholder="Researchers " value="" autocomplete="off">
...
<%  String paras;
   ...
   String url = "http://localhost:5000/node2vecRecommend/PtoR?name="+paras;
